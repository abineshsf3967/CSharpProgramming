...
{
    public enum AccountType{Default,Savings,Balance,RecurringDeposit}
    public class SavingAccount:PersonalInfo,Calculate
    {
        ...
        public SavingAccount(string name,Gender gender,DateTime dob,long mobileNumber,string panNumber,AccountType accountType):base(name,gender,dob,mobileNumber,panNumber)
        {
            s_accountNumber++;
