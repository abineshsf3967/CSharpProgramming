namespace CarModels
{
    public class Eco:Car,Brand
    {
        private static int s_makingID=200;
        ...
        public Eco(string fuelType,int numberOfSeats,string color,int tankCapacity,double numberOfKMDriven,string brandName,string modelName,int engineeNumber,int chasisNumber):base(fuelType,numberOfSeats,color,tankCapacity,numberOfKMDriven)
        {
            s_makingID++;
